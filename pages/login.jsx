...
const LoginPage = () => {
    return (
        <div className="relative py-16 bg-gradient-to-br from-gray-500 to-gray-800">
                    ...
                    <div className="rounded-xl bg-white shadow-xl">
                        <div className="p-6 sm:p-16">
                            <div className="space-y-4">
                                ...
                                <h2 className="mb-8 text-2xl text-cyan-900 font-bold">Log in to unlock the <br /> best of E-Hospa.</h2>
                            </div>
                            <div className="mt-16 grid space-y-4">
                                <button onClick={() => signIn("google", { callbackUrl: "/auth" })} className="group h-12 px-6 border-2 border-gray-300 rounded-full transition duration-300 
